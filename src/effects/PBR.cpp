...
void PBRShaders::UpdateSettings() {
	...
	// Its own section, not weather-blended.
	ClearcoatSettings.Strength = TheSettingManager->GetSettingF("Shaders.PBR.Clearcoat", "Strength");
	ClearcoatSettings.Roughness = TheSettingManager->GetSettingF("Shaders.PBR.Clearcoat", "Roughness");
}
...
void PBRShaders::UpdateConstants() {
	...
	// Not weather-blended -- see ClearcoatSettings.
	Constants.Clearcoat.x = ClearcoatSettings.Strength;
	Constants.Clearcoat.y = ClearcoatSettings.Roughness;
};
