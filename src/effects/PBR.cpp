...
void PBRShaders::UpdateSettings() {
	...
	Settings.Default.Specular = TheSettingManager->GetSettingF("Shaders.PBR.Main", "Specular");
	...
	Settings.Rain.Specular = TheSettingManager->GetSettingF("Shaders.PBR.Rain", "Specular");
	...
	Settings.Night.Specular = TheSettingManager->GetSettingF("Shaders.PBR.Night", "Specular");
	...
	Settings.NightRain.Specular = TheSettingManager->GetSettingF("Shaders.PBR.NightRain", "Specular");
	...
	Settings.Interiors.Specular = TheSettingManager->GetSettingF("Shaders.PBR.Interiors", "Specular");
...
void PBRShaders::UpdateConstants() {
	...
	Constants.Data.x = std::lerp(TheShaderManager->GetTransitionValue(Settings.Default.Specular, Settings.Night.Specular, Settings.Interiors.Specular),
		TheShaderManager->GetTransitionValue(Settings.Rain.Specular, Settings.NightRain.Specular, Settings.Interiors.Specular), rainFactor);
