...
void SkinShaders::UpdateSettings() {
	...
	Constants.SkinSSSData.x = TheSettingManager->GetSettingF("Shaders.Skin.Main", "TranslucencyDistortion");
	...
	Constants.SkinSSSData.w = TheSettingManager->GetSettingF("Shaders.Skin.Main", "WrapDiffuse");
}